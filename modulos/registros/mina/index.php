...
// Verificar permiso
if (!tienePermiso('registros.produccion_mina.acceder')) {
    header("Location: ../../../dashboard.php?error=no_autorizado");
    exit;
}

// Título de la página
$titulo = "Registro de Producción Mina";

// Definir CSS y JS adicionales para este módulos
$css_adicional = [
    'assets/css/colors.css',
    'assets/plugins/datatables/css/datatables.min.css',
    'assets/plugins/datepicker/css/bootstrap-datepicker.min.css',
    'assets/css/registros/mina/produccion_mina.css',
...
$js_adicional = [
    ...
    'assets/js/registros/mina/produccion_mina.js'
];
...
<div id="main-content" class="main-content">
    ...
    <div class="filtros-container">
        ...
        <div class="filtros-content">
            ...
            <div class="filtro-grupo">
                <label for="filtro-frente" class="filtro-label">Frente</label>
                <select id="filtro-frente" class="filtro-select">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-registro-titulo">Nuevo Registro de Producción</h5>
                        ...
                        <div class="card-form mb-3">
                            ...
                            <div class="card-form-body">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="registro-frente" class="form-label form-label-sm">Frente <span class="text-danger">*</span></label>
                                            <select class="form-control form-control-sm" id="registro-frente" required>
                        ...
                        <div class="card-form mb-3">
                            ...
                            <div class="card-form-body">
                                <div class="row g-2">
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="registro-material-extraido" class="form-label form-label-sm">Material Extraído (TM) <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control form-control-sm" id="registro-material-extraido" step="0.01" min="0" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="registro-desmonte" class="form-label form-label-sm">Desmonte (TM) <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control form-control-sm" id="registro-desmonte" step="0.01" min="0" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="registro-ley-geologo" class="form-label form-label-sm">Ley Inferido Geólogo (g/t)</label>
                                            <input type="number" class="form-control form-control-sm" id="registro-ley-geologo" step="0.01" min="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if (tienePermiso('registros.produccion_mina.crear')): ?>
