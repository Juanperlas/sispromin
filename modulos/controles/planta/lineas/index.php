...
$js_adicional = [
    ...
    'assets/js/controles/planta/lineas/lineas_planta.js'
];
...
<div id="main-content" class="main-content">
    ...
    <?php if (tienePermiso('controles.planta.lineas.crear')): ?>
