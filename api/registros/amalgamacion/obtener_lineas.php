...
try {
    ...
    // Consulta para obtener todas las líneas de amalgamación activas
    $sql = "SELECT id, codigo, nombre FROM lineas_amalgamacion ORDER BY codigo ASC";
    ...
    error_log("Error en obtener_lineas.php (registros/amalgamacion): " . $e->getMessage());
}
