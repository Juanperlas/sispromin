...
try {
    ...
    // Consulta para obtener todos los turnos de amalgamación activos
    $sql = "SELECT id, codigo, nombre FROM turnos_amalgamacion ORDER BY codigo ASC";
    ...
    error_log("Error en obtener_turnos.php (registros/amalgamacion): " . $e->getMessage());
}
