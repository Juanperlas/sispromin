...
try {
    ...
    // Consulta para obtener todos los turnos activos
    $sql = "SELECT id, codigo, nombre FROM turnos_mina ORDER BY codigo ASC";
    ...
    error_log("Error en obtener_turnos.php (registros/mina): " . $e->getMessage());
}
