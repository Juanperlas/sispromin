...
try {
    ...
    // Consulta para obtener todos los turnos de flotación
    $sql = "SELECT id, codigo, nombre FROM turnos_flotacion ORDER BY codigo ASC";
    ...
    error_log("Error en obtener_turnos.php (registros/flotacion): " . $e->getMessage());
}
