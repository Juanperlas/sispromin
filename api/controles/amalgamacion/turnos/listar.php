...
// Verificar permiso
if (!tienePermiso("controles.amalgamacion.turnos.ver")) {
    http_response_code(403);
    echo json_encode(["success" => false, "message" => "No tiene permisos para ver turnos de amalgamación"]);
    exit;
}
...
try {
    ...
    // Ejecutar consulta
    $turnos = $conexion->select($sql, $params);
    ...
    error_log("Error en listar.php (turnos_amalgamacion): " . $e->getMessage());
}
