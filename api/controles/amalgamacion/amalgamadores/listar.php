...
try {
    ...
    // Ejecutar consulta
    $amalgamadores = $conexion->select($sql, $params);

    // Preparar datos para la respuesta
    $data = [];
    foreach ($amalgamadores as $row) {
        // Formatear fecha
    ...
    error_log("Error en listar.php (amalgamadores): " . $e->getMessage());
}
