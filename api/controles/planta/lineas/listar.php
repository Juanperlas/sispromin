...
// Verificar permiso
if (!tienePermiso("controles.planta.lineas.ver")) {
    http_response_code(403);
    echo json_encode(["success" => false, "message" => "No tiene permisos para ver líneas de planta"]);
    exit;
}
...
try {
    ...
    // Ejecutar consulta
    $lineas = $conexion->select($sql, $params);
    ...
    error_log("Error en listar.php (lineas_planta): " . $e->getMessage());
}
