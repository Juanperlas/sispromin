...
// Verificar permiso
if (!tienePermiso("controles.planta.turnos.ver")) {
    http_response_code(403);
    echo json_encode(["success" => false, "message" => "No tiene permisos para ver turnos de planta"]);
    exit;
}
...
try {
    ...
    error_log("Error en listar.php (turnos_planta): " . $e->getMessage());
}
