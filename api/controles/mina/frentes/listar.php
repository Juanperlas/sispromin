...
try {
    ...
    // Ejecutar consulta
    $frentes = $conexion->select($sql, $params);

    // Preparar datos para la respuesta
    $data = [];
    foreach ($frentes as $row) {
        // Formatear fecha
    ...
    error_log("Error en listar.php (frentes_mina): " . $e->getMessage());
}
