...
// Verificar permiso
if (!tienePermiso("controles.mina.turnos.ver")) {
    http_response_code(403);
    echo json_encode(["success" => false, "message" => "No tiene permisos para ver turnos de mina"]);
    exit;
}
...
try {
    ...
    error_log("Error en listar.php (turnos_mina): " . $e->getMessage());
}
