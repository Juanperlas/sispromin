/**
 * Gestión de turnos de amalgamación
 * Funcionalidades para listar, crear y editar turnos de amalgamación
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initDataTable() {
    turnosTable = $("#turnos-table").DataTable({
      ...
      responsive: true,
      ajax: {
        url: getUrl("api/controles/amalgamacion/turnos/listar.php"),
        type: "POST",
        data: (d) => {
          if (d.length == -1) {
            d.length = 10000;
      ...
      buttons: [
        ...
        },
        {
          ...
          customize: (doc) => {
            ...
            doc.content.unshift({
              text: "REPORTE DE TURNOS DE AMALGAMACIÓN",
              style: "header",
              alignment: "center",
              margin: [0, 15, 0, 15],
            });
            ...
            doc.info = {
              title: "Reporte de Turnos de Amalgamación",
              author: "SISPROMIN",
              subject: "Listado de Turnos de Amalgamación",
            };
          },
          filename:
            "Reporte_Turnos_Amalgamacion_" +
  ...
  function mostrarModalDetalles(id) {
    ...
    $.ajax({
      url: getUrl("api/controles/amalgamacion/turnos/obtener.php"),
      type: "GET",
      data: { id: id },
      dataType: "json",
      success: (response) => {
  ...
  function guardarTurno() {
    ...
    $.ajax({
      url: getUrl("api/controles/amalgamacion/turnos/guardar.php"),
      type: "POST",
      data: formData,
      processData: false,
      contentType: false,
