/**
 * Gestión de turnos de planta
 * Funcionalidades para listar, crear y editar turnos de planta
 * NUEVA FUNCIONALIDAD: Panel lateral de detalles
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initDataTable() {
    turnosTable = $("#turnos-table").DataTable({
      ...
      responsive: true,
      ajax: {
        url: getUrl("api/controles/planta/turnos/listar.php"),
        type: "POST",
        data: (d) => {
          if (d.length == -1) {
            d.length = 10000;
      ...
      buttons: [
        ...
        },
        {
          ...
          customize: (doc) => {
            ...
            doc.content.unshift({
              text: "REPORTE DE TURNOS DE PLANTA",
              style: "header",
              alignment: "center",
              margin: [0, 15, 0, 15],
            });
            ...
            doc.info = {
              title: "Reporte de Turnos de Planta",
              author: "SISPROMIN",
              subject: "Listado de Turnos de Planta",
            };
          },
          filename:
            "Reporte_Turnos_Planta_" + new Date().toISOString().split("T")[0],
      ...
      pageLength: 25,
      initComplete: () => {
        // NUEVA FUNCIONALIDAD: Evento para seleccionar fila
  ...
  // NUEVA FUNCIONALIDAD: Función para cargar detalles del turno en el panel lateral
  function cargarDetallesTurno(id) {
    ...
    $.ajax({
      url: getUrl("api/controles/planta/turnos/obtener.php"),
      type: "GET",
      data: { id: id },
      dataType: "json",
      success: (response) => {
  ...
  function guardarTurno() {
    ...
    $.ajax({
      url: getUrl("api/controles/planta/turnos/guardar.php"),
      type: "POST",
      data: formData,
      processData: false,
      contentType: false,
      ...
      success: (response) => {
        ...
        if (response.success) {
          ...
          // NUEVA FUNCIONALIDAD: Actualizar panel de detalles si está activo
  ...
  function aplicarFiltros() {
    ...
    // NUEVA FUNCIONALIDAD: Limpiar panel de detalles al aplicar filtros
    $("#turno-detalle .detail-content").html(`
            <div class="detail-empty">
                <div class="detail-empty-icon">
  ...
  function limpiarFiltros() {
    ...
    // NUEVA FUNCIONALIDAD: Limpiar panel de detalles al limpiar filtros
    $("#turno-detalle .detail-content").html(`
            <div class="detail-empty">
                <div class="detail-empty-icon">
                    <i class="bi bi-info-circle"></i>
